...
public class Calculator {
    ...
    public String button(String trans) {
        ...
        if(trans.equals("AC"))
            ...
            finalresult = evaluateExpression(list);
            finalresult = finalresult * finalresult * finalresult;
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        ...
        else if(trans.equals("Pi")){
            finalresult = 3.14159;
            list.clear();
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("tan")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.tan(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("Atan")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.atan(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("sin")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.sin(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("Asin")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.asin(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("cos")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.cos(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if(trans.equals("Acos")) {
            finalresult = evaluateExpression(list);
            finalresult = Math.acos(finalresult);
            list.remove(list.size()-1);
            list.add(String.valueOf(finalresult));
        }
        else if (!trans.equals("=")) {
